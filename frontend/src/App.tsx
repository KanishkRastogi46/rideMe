...
function App() {
  ...
  return (
    <div className="min-w-full min-h-screen flex flex-col items-center">
      <h1 className='absolute top-[5vh] text-black text-4xl font-mono text-center font-extrabold z-10 mt-0'>RideMe</h1>
      <div className="flex justify-start mt-0">
        <img 
          ...
          alt="Cab Booking"
          className="mb-8 w-screen h-[85vh] md:h-[90vh] md:object-cover relative z-0 opacity-85"
        />
      </div>
